...
inner_join(continent_asia, acled_asia, by = c("geounit" = "country")) -> acled_mapping

  
# let's make a animated plot of the number of contentious political events for 2020 
